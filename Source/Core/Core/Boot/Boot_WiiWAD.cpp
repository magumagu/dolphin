...
bool CBoot::Boot_WiiWAD(const std::string& _pFilename)
{
	...
	Memory::CPU_Write_U16(ContentLoader.GetIosVersion(), 0x00003140);
	Memory::CPU_Write_U16(0xFFFF, 0x00003142);
	Memory::CPU_Write_U32(Memory::CPU_Read_U32(0x00003140), 0x00003188);
