...
bool CBoot::EmulatedBS2_GC()
{
	...
	Memory::CPU_Write_U32(0x0D15EA5E, 0x80000020); // Booted from bootrom. 0xE5207C22 = booted from jtag
	Memory::CPU_Write_U32(Memory::REALRAM_SIZE, 0x80000028); // Physical Memory Size (24MB on retail)
	// TODO determine why some games fail when using a retail ID. (Seem to take different EXI paths, see Ikaruga for example)
	Memory::CPU_Write_U32(0x10000006, 0x8000002C); // Console type - DevKit  (retail ID == 0x00000003) see YAGCD 4.2.1.1.2

	Memory::CPU_Write_U32(SConfig::GetInstance().m_LocalCoreStartupParameter.bNTSC
						 ? 0 : 1, 0x800000CC); // Fake the VI Init of the IPL (YAGCD 4.2.1.4)

	Memory::CPU_Write_U32(0x01000000, 0x800000d0); // ARAM Size. 16MB main + 4/16/32MB external (retail consoles have no external ARAM)

	Memory::CPU_Write_U32(0x09a7ec80, 0x800000F8); // Bus Clock Speed
	Memory::CPU_Write_U32(0x1cf7c580, 0x800000FC); // CPU Clock Speed

	Memory::CPU_Write_U32(0x4c000064, 0x80000300); // Write default DFI Handler:     rfi
	Memory::CPU_Write_U32(0x4c000064, 0x80000800); // Write default FPU Handler:     rfi
	Memory::CPU_Write_U32(0x4c000064, 0x80000C00); // Write default Syscall Handler: rfi

	Memory::CPU_Write_U64((u64)CEXIIPL::GetGCTime() * (u64)40500000, 0x800030D8); // Preset time base ticks
	// HIO checks this
	...
	VolumeHandler::ReadToPtr(Memory::CPU_GetPointer(0x81200000), iAppLoaderOffset + 0x20, iAppLoaderSize, false);
...
bool CBoot::SetupWiiMemory(IVolume::ECountry country)
{
	...
	File::CreateFullPath(settings_Filename);
	{
		...
		Memory::CPU_CopyToEmu(0x3800, gen.GetData(), SettingsHandler::SETTINGS_SIZE);
	}
	...
	*/
	...
	Memory::CPU_Write_U32(0x0D15EA5E, 0x00000020);                  // Another magic word
	Memory::CPU_Write_U32(0x00000001, 0x00000024);                  // Unknown
	Memory::CPU_Write_U32(Memory::REALRAM_SIZE, 0x00000028);        // MEM1 size 24MB
	Memory::CPU_Write_U32(0x00000023, 0x0000002c);                  // Production Board Model
	Memory::CPU_Write_U32(0x00000000, 0x00000030);                  // Init
	Memory::CPU_Write_U32(0x817FEC60, 0x00000034);                  // Init
	// 38, 3C should get start, size of FST through apploader
	Memory::CPU_Write_U32(0x38a00040, 0x00000060);                  // Exception init
	Memory::CPU_Write_U32(0x8008f7b8, 0x000000e4);                  // Thread Init
	Memory::CPU_Write_U32(Memory::REALRAM_SIZE, 0x000000f0);        // "Simulated memory size" (debug mode?)
	Memory::CPU_Write_U32(0x8179b500, 0x000000f4);                  // __start
	Memory::CPU_Write_U32(0x0e7be2c0, 0x000000f8);                  // Bus speed
	Memory::CPU_Write_U32(0x2B73A840, 0x000000fc);                  // CPU speed
	Memory::CPU_Write_U16(0x0000, 0x000030e6);                  // Console type
	Memory::CPU_Write_U32(0x00000000, 0x000030c0);                  // EXI
	Memory::CPU_Write_U32(0x00000000, 0x000030c4);                  // EXI
	Memory::CPU_Write_U32(0x00000000, 0x000030dc);                  // Time
	Memory::CPU_Write_U32(0x00000000, 0x000030d8);                  // Time
	Memory::CPU_Write_U16(0x8201, 0x000030e6);                  // Dev console / debug capable
	Memory::CPU_Write_U32(0x00000000, 0x000030f0);                  // Apploader
	Memory::CPU_Write_U32(0x01800000, 0x00003100);                  // BAT
	Memory::CPU_Write_U32(0x01800000, 0x00003104);                  // BAT
	Memory::CPU_Write_U32(0x00000000, 0x0000310c);                  // Init
	Memory::CPU_Write_U32(0x8179d500, 0x00003110);                  // Init
	Memory::CPU_Write_U32(0x04000000, 0x00003118);                  // Unknown
	Memory::CPU_Write_U32(0x04000000, 0x0000311c);                  // BAT
	Memory::CPU_Write_U32(0x93400000, 0x00003120);                  // BAT
	Memory::CPU_Write_U32(0x90000800, 0x00003124);                  // Init - MEM2 low
	Memory::CPU_Write_U32(0x93ae0000, 0x00003128);                  // Init - MEM2 high
	Memory::CPU_Write_U32(0x93ae0000, 0x00003130);                  // IOS MEM2 low
	Memory::CPU_Write_U32(0x93b00000, 0x00003134);                  // IOS MEM2 high
	Memory::CPU_Write_U32(0x00000012, 0x00003138);                  // Console type
	// 40 is copied from 88 after running apploader
	Memory::CPU_Write_U32(0x00090204, 0x00003140);                  // IOS revision (IOS9, v2.4)
	Memory::CPU_Write_U32(0x00062507, 0x00003144);                  // IOS date in USA format (June 25, 2007)
	Memory::CPU_Write_U16(0x0113, 0x0000315e);                  // Apploader
	Memory::CPU_Write_U32(0x0000FF16, 0x00003158);                  // DDR ram vendor code
	Memory::CPU_Write_U32(0x00000000, 0x00003160);                  // Init semaphore (sysmenu waits for this to clear)
	Memory::CPU_Write_U32(0x00090204, 0x00003188);                  // Expected IOS revision

	Memory::CPU_Write_U8(0x80, 0x0000315c);                         // OSInit
	Memory::CPU_Write_U16(0x0000, 0x000030e0);                      // PADInit
	Memory::CPU_Write_U32(0x80000000, 0x00003184);                  // GameID Address

	// Fake the VI Init of the IPL
	Memory::CPU_Write_U32(SConfig::GetInstance().m_LocalCoreStartupParameter.bNTSC ? 0 : 1, 0x000000CC);

	// Clear exception handler. Why? Don't we begin with only zeros?
	for (int i = 0x3000; i <= 0x3038; i += 4)
	{
		Memory::CPU_Write_U32(0x00000000, 0x80000000 + i);
	}
	return true;
}
...
bool CBoot::EmulatedBS2_Wii()
{
	...
	VolumeHandler::ReadToPtr(Memory::CPU_GetPointer(0x3180), 0, 4, true);
	...
	if (VolumeHandler::IsValid() && VolumeHandler::IsWii())
	{
		...
		VolumeHandler::ReadToPtr(Memory::CPU_GetPointer(0x81200000), iAppLoaderOffset + 0x20, iAppLoaderSize, true);
		...
		Memory::CPU_Write_U32(firmwareVer ? firmwareVer : 0x00090204, 0x00003140);
